...
import 'package:restaurent/common/address_bottom_sheet.dart';
...
import 'package:restaurent/controller/cart_controller.dart';
import 'package:restaurent/controller/foods_controller.dart';
import 'package:restaurent/controller/login_controller.dart';
import 'package:restaurent/hooks/fetch_default.dart';
import 'package:restaurent/hooks/fetch_restaurant.dart';
import 'package:restaurent/models/address_response.dart';
import 'package:restaurent/models/cart_request.dart';
...
import 'package:restaurent/views/auth/phone_verification_page.dart';
import 'package:restaurent/views/orders/order_page.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          double price = (widget.food.price + controller.additivePrice) * controller.count.value;

                          var additives = controller.getCartAdditive();
                          var productId = widget.food.id;
                          var quantity = controller.count.value;
                          ...
                          if (productId != null && additives != null && quantity != null && price != null) {
                            ...
                            // Convert CartRequest to JSON string
                            String cart = cartRequestToJson(data);
                            print('Cart JSON: $cart');

                            // Check if cart string is not null
                            if (cart.isNotEmpty) {
                              cartController.addToCart(cart);
                            } else {
                              print("Error: Cart JSON string is null or empty");
                            }
                          } else {
                            print("Error: One or more input values are null");
                          }
                        },
